...
export const Headers = createContext([
  { header: 'Büro Horw', src: "https://meinhof.ch/src/zugeschnittenProject/titelHorw.jpg" , path: "BueroHorw"},
  { header: 'Büro Videolution', src: "https://meinhof.ch/src/zugeschnittenProject/titelVideolution.jpg" , path: "BüroVideolution" }, 
  { header: 'Puristisches Badezimmer', src: "https://meinhof.ch/src/zugeschnittenProject/titelBadezimmer.jpg" , path: "PuristischesBadezimmer" },
  { header: 'Studio Neubau', src: "https://meinhof.ch/src/zugeschnittenProject/titelRoggwil.jpg" , path: "StudioNeubau" },
  { header: 'Wohnung am See', src: "https://meinhof.ch/src/zugeschnittenProject/titelNeuenburg.jpg" , path: "WohnungamSee" }
]);
